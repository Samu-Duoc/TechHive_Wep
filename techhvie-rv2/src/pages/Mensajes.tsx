...
interface Mensaje {
    ...
    return (
        ...
        <div className="mensajes-header d-flex align-items-center justify-content-between mb-4">
            <div>
            ...
            <button className={`btn btn-sm ${filtro === "RESPONDIDO" ? "btn-primary" : "btn-outline-secondary"}`} onClick={() => setFiltro("RESPONDIDO")}>Respondidos</button>
            <button className={`btn btn-sm ${filtro === "ARCHIVADO" ? "btn-primary" : "btn-outline-secondary"}`} onClick={() => setFiltro("ARCHIVADO")}>Archivados</button>
            </div>
        </div>
        ...
        <div className="row">
            ...
            <div className="card p-3">
                <h5 className="mb-3">Buscar por ID</h5>
                <ContactoBuscar />
            </div>
            </div>
