...
const Productos: React.FC = () => {
    ...
    {/*Componentes de estado para filtros y cantidades*/}
    const [categoriaActiva, setCategoriaActiva] = useState<string>("all");  {/*Se encarga de manejar la categoría activa*/}
    const [terminoBusqueda, setTerminoBusqueda] = useState<string>("");    {/*Se encarga de manejar el término de búsqueda (puede que se borre, por falta de base de datos)*/}
    const [cantidades, setCantidades] = useState<{ [key: number]: number }>({}); {/* Maneja las cantidades de cada producto*/}
...
{/*Componente de Handlers (Sirve para cambiar la cantidad de productos)*/}
    ...
    {/*Compónente de agregar al carrito (aún no implementado)*/}
    const agregarAlCarrito = (producto: Producto) => {
        // TODO: Implementar lógica de carrito
        const cantidad = cantidades[producto.id] || 1;
        alert(`Agregado al carrito: ${cantidad}x ${producto.titulo}`);
    };
    ...
    return (
            ...
            <div className="row mb-4">
                <div className="col-md-8">
                    <div className="btn-group">
                        ...
                        {['Computadores', 'Smartphones', 'Accesorios', 'Audio', 'Componentes', 'Perifericos'].map(cat => (
                            <button
                                key={cat}
        ...
        {/*Filtrados de productos según categoría y búsqueda (intentar hacer que funcione la búsqueda junto con la categoría)*/}
            {/* Grid de Productos */}
            <div className="row mt-4">
                {productosFiltrados.length === 0 ? (
                    ...
                    productosFiltrados.map(producto => (
                        <div key={producto.id} className="col-sm-6 col-md-4 mb-4">
                            <div className="card h-100 border-0 shadow-sm">  // Suavida el borde de las tarjetas y agrega sombra
                ...
                {/* Cuerpo de la tarjeta, dondee se muestra la información del producto
                                // Intentar cambiarle el diseño*/}
                                </div>
